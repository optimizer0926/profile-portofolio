            ...
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  ...
                  <ProjectSectionText>
                    Frontend was very important for the user experience.
                    It is well developed with Full Responsive.
                  </ProjectSectionText>
                </ProjectTextRow>
              </ProjectSectionContent>
              <Image
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow>
              ...
              <ProjectSectionText>
                This app is design to be most extensible for future updates.
                Actually It is updating adding more functions to the app and it becomes
                more and more popular for users by regular updates
              </ProjectSectionText>
            </ProjectTextRow>
            <Image
              raised
              ...
              <ProjectSection>
                <ProjectSectionContent>
                  <ProjectTextRow center>
                    ...
                    <ProjectSectionText>
                      The design of the product allowed for users to get
                      interactive experiences to Metaverse.
                    </ProjectSectionText>
                  </ProjectTextRow>
                </ProjectSectionContent>
              </ProjectSection>
              ...
              <ProjectSection>
                <ProjectSectionContent width="xl">
                  <ProjectTextRow justify="end" width="s">
                    ...
                    <ProjectSectionText>
                      Users can pick an excellent character in the NFT to
                      play or earn money.
                    </ProjectSectionText>
                  </ProjectTextRow>
                </ProjectSectionContent>
          ...
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionText>
                ...
                platform were{' '}
                to become a foundation for their next generation MetaVerse.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
